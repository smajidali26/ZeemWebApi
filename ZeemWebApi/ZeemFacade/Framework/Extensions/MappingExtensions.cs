...
using Zeem.Core;
using Zeem.DomainContracts;

namespace ZeemFacade.Framework.Extensions
{
    /// <summary>
    ...
    public static class MappingExtensions
    {
        ...
        /// <param name="entity">Entity to map from</param>
        /// <returns>Mapped model</returns>
        public static ICollection<TModel> ToModel<TModel>(this IEnumerable<BaseEntity> entity) where TModel : BaseEntityModel
        {
            var baseEntities = entity?.ToList();
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));

            var tModel = new List<TModel>();
            baseEntities.ForEach(x => tModel.Add(x.Map<TModel>()));
            return tModel;
        }
        ...
        public static ICollection<TEntity> ToEntity<TEntity>(this IEnumerable<BaseEntityModel> entity) where TEntity : BaseEntity
        {
            var baseEntities = entity?.ToList();
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
            ...
            baseEntities.ForEach(x => tEntity.Add(x.Map<TEntity>()));
            return tEntity;
        }
